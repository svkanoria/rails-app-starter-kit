...
1. For correctly sending emails, change the
   config.action_mailer.default_url_options 'host' parameter in
   /config/environments/production.rb to suit your application.
