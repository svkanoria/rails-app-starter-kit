...
1. To set up outgoing email in production (and simulation otherwise), set the
   ...
   The APPLICATION_HOST variable is required. The rest may be provided only in
   production, since you will probably not want to send real emails in other
   enrivonments.
