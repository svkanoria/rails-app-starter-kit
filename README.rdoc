...
1. Complete user upload management via a media library
...
Most applications need some way of storing media and other files uploaded by
users, and of associating uploads with models. For example, an attachment to a
post, a user profile pic etc.
...
* Client-side code:
  * /app/assets/javascripts/shared/angular/modules/media_library/
