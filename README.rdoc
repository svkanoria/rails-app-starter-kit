...
Note the 'erb' in 'routes.js.erb'. This is so that we can use the 'asset_path'
helper to refer to the templates. Without this, we would have had to place the
templates in the /public folder, and would have lost the advantage of caching,
or of using HAML or Slim or any other pre-processor (if desired in future).
