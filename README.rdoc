...
1. The Puma web server supports concurrent request handling, by allowing
   ...
   The defaults are 2 and 5 respectively.

   IMPORTANT: MAX_THREADS will be ignored for now, as we have not yet tested the
   app's thread safety. We will be working on this soon.
