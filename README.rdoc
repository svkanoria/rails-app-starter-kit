...
1. Install pg gem - this can be a pain
    See http://stackoverflow.com/questions/19262312/installing-pg-gem-failure-to-build-native-extension
    for help.

1. Create a rails-app-starter-kit_development database
    Or edit config/database.yml to suit your needs.

== Out-of-the-box Functionality

=== Authentication

Authentication is done via devise (see https://github.com/plataformatec/devise).
