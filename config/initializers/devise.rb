...
Devise.setup do |config|
  ...
  # config.secret_key = '21ca438c47ab8cad873a707864daae2b97e570eecc1e3fe8a7bbd6a3735fbec1e74ceb3808e2989688f7850a3a6cf748d2aa8319a45b9871af3c86f28ba22be6'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer.
  # note that it will be overwritten if you use your own mailer class with a
  # default "from" parameter.
  # MY NOTE: Since we use our own mechanism for determining the sender (see
  # /app/mailers/concerns/configurable_delivery_mailer.rb), the line below is
  # redundant. Changing it will have no effect.
  config.mailer_sender = 'change-me-at-config-initializers-devise@example.com'

  # Configure the class responsible to send e-mails
  # MY NOTE: We have uncommented the line below, and replaced 'Devise::Mailer'
  # with 'MyDeviseMailer', which is integrated with our configurable outgoing
  # email settings.
  ...
  # is used not for finding the user to authenticate, but for actually
  # authenticating it.
  config.request_keys = [:subdomain]

  # Configure which authentication keys should be case-insensitive.
  # These keys will be down-cased upon creating or modifying a user and when
  ...
  # It will change confirmation, password recovery and other workflows to behave
  # the same regardless if the e-mail provided was right or wrong.
  ...
  # config.pepper = 'c5e4fa660777d328d9ff45c5ae7bfaddbe6688f99ac8cc3442a32b248ce6e79f56f3c8eaed87d585fcb669c4c28d4dd63f8868248eed845e1b1de9856a36ed3a'

  # ==> Configuration for :confirmable
  # A period that the user is allowed to access the website even without
  # confirming their account. For instance, if set to 2.days, the user will be
  # able to access the website for two days without confirming their account,
  # access will be blocked just in the third day. Default is 0.days, meaning the
  ...
  # :failed_attempts = Locks an account after a # of failed sign-in attempts.
  ...
  # :time  = Re-enables login after some amount of time (see :unlock_in below)
  ...
  # Set this configuration to false if you want /users/sign_out to sign out only
  # the current scope. By default, Devise signs out all scopes.
  # config.sign_out_all_scopes = true

  # ==> Navigation configuration
  # Lists the formats that should be treated as navigational. Formats like :html
  # should redirect to the sign in page when the user does not have access, but
  # formats like :xml or :json should return 401.
  #
  ...
  # MY NOTE: For authentication via 3rd party providers
