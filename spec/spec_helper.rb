...
# the additional setup, and require it from the spec files that need it.
#
...
=begin
  ...
  # test failures related to randomization by passing the same `--seed` value as
  # the one that triggered the failure.
